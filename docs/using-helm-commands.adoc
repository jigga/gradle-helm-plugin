...
The plugin `io.github.jigga.helm-commands` allows you to use Helm commands directly, similar to what you would do
...
Check the link:https://jigga.github.io/gradle-helm-plugin/[API Reference]
...
[source,groovy]
----
import io.github.jigga.gradle.plugins.helm.command.tasks.*

plugins {
    id 'io.github.jigga.helm-commands' version '<VERSION>'
}
