...
All plugins IDs are prefixed the namespace `io.github.jigga`.
...
----
plugins {
    id 'io.github.jigga.helm-commands' version '{project-version}'
}
----
...
----
plugins {
    id 'io.github.jigga.helm-publish' version '{project-version}'
}
----
...
----
plugins {
    id 'io.github.jigga.helm-releases' version '{project-version}'
}
----
