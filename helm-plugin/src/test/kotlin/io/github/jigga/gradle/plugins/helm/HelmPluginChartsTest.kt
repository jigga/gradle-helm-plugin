...
import io.github.jigga.gradle.plugins.helm.command.tasks.HelmLint
import io.github.jigga.gradle.plugins.helm.command.tasks.HelmPackage
import io.github.jigga.gradle.plugins.helm.command.tasks.HelmUpdateDependencies
...
import io.github.jigga.gradle.plugins.helm.tasks.HelmFilterSources
                ...
                assertThat(project, name = "project")
                    ...
                    .all {
                        prop(HelmUpdateDependencies::chartDir).dirValue()
                            .isEqualTo(project.layout.buildDirectory.get().asFile.resolve("helm/charts/my-chart"))
                    }
            }
