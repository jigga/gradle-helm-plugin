...
class PluginVersionSynchronization {
    ...
    /**
     * This verification is needed before https://github.com/jigga/gradle-helm-plugin/issues/24 is implemented to have the same plugin version with documentation
     */
    @Test
